...
class KeypointPainter(Configurable):
    ...
    def _draw_skeleton(self, ax, x, y, v, x_, y_, w_, h_, *,
    ...
    def annotation(self, ax, ann, *, color=None, text=None, subtext=None, alpha=1.0):
        ...
        self._draw_skeleton(ax, x, y, v, x_, y_, w_, h_, color=color,
...
#MARTY ADD
    def annotation_text(self, ax, ann, *, color=None, text=None, subtext=None, alpha=1.0):
        if isinstance(color, (int, np.intc)):
            color = matplotlib.cm.get_cmap('tab20')((color % 20 + 0.05) / 20)
